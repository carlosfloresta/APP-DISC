...
public class Descricao_Activity extends AppCompatActivity {
    ...
    String urlwebservices = "link API/alterarempresa.php";
    String urlwebservices2 = "link API/selecionaempresa.php";
    String urlwebservices3 = "link API/verificateste.php";
